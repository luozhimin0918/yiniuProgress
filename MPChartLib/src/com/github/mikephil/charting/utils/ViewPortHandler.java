...
public class ViewPortHandler {
    ...
    private OnLongPressIndicatorHandler onLongPressIndicatorHandler;

    public void setOnLongPressIndicatorHandler(OnLongPressIndicatorHandler onLongPressIndicatorHandler) {
        this.onLongPressIndicatorHandler = onLongPressIndicatorHandler;
    }

    public OnLongPressIndicatorHandler getOnLongPressIndicatorHandler() {
        return onLongPressIndicatorHandler;
    }
