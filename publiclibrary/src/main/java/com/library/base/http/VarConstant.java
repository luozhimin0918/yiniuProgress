...
public class VarConstant {
    ...
    public static final String HTTP_VERSION_VALUE = "6.2.0";
    ...
    public static final String OCLASS_BLOG_WRITE = "blog_writer";//专栏作者
    ...
    public static final String OACTION_PROFILE = "profile";//列表
...
//    public static final String SINA_CALLBACK = "http://sns.whalecloud.com";
    ...
    public static final String COLLECT_TYPE_BLOG = "blog";//博客
    ...
    public static final String SEARCH_TYPE_VIEWPOINT = "point";//点评
