...
public class ImageUtil {
     ...
     * @param uri
     */
    public static Bitmap getBitmapFormUri(Activity ac, Uri uri,int w,int h) throws FileNotFoundException, IOException {
        ...
        if ((originalWidth == -1) || (originalHeight == -1))
            return null;
        float hh = w;//这里设置高度为800f
        float ww = h;//这里设置宽度为480f
