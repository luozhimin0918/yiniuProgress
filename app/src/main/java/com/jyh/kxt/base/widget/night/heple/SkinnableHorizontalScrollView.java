 ...
 */
public class SkinnableHorizontalScrollView extends HorizontalScrollView implements Skinnable {

    private AttrsHelper mAttrsHelper;

    public SkinnableHorizontalScrollView(Context context) {
        this(context, null);
    }

    public SkinnableHorizontalScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SkinnableHorizontalScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
