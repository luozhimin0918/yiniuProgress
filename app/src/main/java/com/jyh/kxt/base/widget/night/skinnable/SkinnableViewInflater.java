package com.jyh.kxt.base.widget.night.skinnable;
...
import com.jyh.kxt.base.widget.night.heple.SkinnableBannerLayout;
import com.jyh.kxt.base.widget.night.heple.SkinnableButton;
...
import com.jyh.kxt.base.widget.night.heple.SkinnableRecyclerView;
    ...
    public final View createView(View parent, final String name, @NonNull Context context,
        ...
        switch (name) {
            case "View":
                ...
                break;
            case "ViewGroup":
                view = new SkinnableViewGroup(context, attrs);
                break;
            case "RadioButton":
                view = new SkinnableRadioButton(context, attrs);
                break;
            case "RadioGroup":
                view = new SkinnableRadioGroup(context, attrs);
                break;
            case "TextView":
            ...
            case "Button":
                ...
                break;
            case "EditText":
                view = new SkinnableEditText(context, attrs);
                break;
            case "LinearLayout":
            ...
            case "android.support.v7.widget.Toolbar":
                ...
                break;
            case "com.library.widget.handmark.PullToRefreshListView":
                view = new SkinnablePullToRefreshListView(context, attrs);
                break;
            case "com.library.widget.viewpager.GeneralBannerLayout":
                view = new SkinnableGeneralBannerLayout(context, attrs);
                break;
            ...
            case "android.support.v7.widget.RecyclerView":
                view = new SkinnableRecyclerView(context, attrs);
                break;
            case "ToggleButton":
                view = new SkinnableToggleButton(context, attrs);
                break;
            case "ImageButton":
                view = new SkinnableImageButton(context, attrs);
                break;
