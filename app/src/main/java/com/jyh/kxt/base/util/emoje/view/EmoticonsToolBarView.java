package com.jyh.kxt.base.util.emoje.view;
...
import com.jyh.kxt.base.util.emoje.bean.EmoticonSetBean;
import com.jyh.kxt.base.util.emoje.utils.EmoticonsKeyboardBuilder;
import com.jyh.kxt.base.util.emoje.utils.Utils;
import com.jyh.kxt.base.util.emoje.utils.imageloader.ImageLoader;
import com.jyh.kxt.base.util.emoje.view.I.IEmoticonsKeyboard;
...
public class EmoticonsToolBarView extends RelativeLayout implements IEmoticonsKeyboard {
    ...
    public EmoticonsToolBarView(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.view_emoje_bar, this);
