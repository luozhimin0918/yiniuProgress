 ...
 */
public class SkinnableImageButton extends ImageButton implements Skinnable {

    private AttrsHelper mAttrsHelper;

    public SkinnableImageButton(Context context) {
        this(context, null);
    }

    public SkinnableImageButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SkinnableImageButton(Context context, AttributeSet attrs, int defStyleAttr) {
