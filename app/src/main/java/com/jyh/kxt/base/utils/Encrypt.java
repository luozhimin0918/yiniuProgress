...
public class Encrypt {
    ...
    /**
     * @param data
     * @return 最终加密 拼接加密后的数据
     * @throws UnsupportedEncodingException
     * @throws NoSuchAlgorithmException
     */
    public static String appendEncrypt(String data) throws UnsupportedEncodingException, NoSuchAlgorithmException {
        StringBuffer newData = new StringBuffer();
        String key = getKey();
        newData.append(key.substring(0, 4)).append(encrypt(data, key, 0)).append(key.substring(4, key.length()));
        Log.i("info", newData.toString());
