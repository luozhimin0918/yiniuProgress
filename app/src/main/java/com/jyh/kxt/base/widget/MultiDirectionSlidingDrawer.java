...
public class MultiDirectionSlidingDrawer extends ViewGroup {
    ...
    public MultiDirectionSlidingDrawer(Context context, AttributeSet attrs, int defStyle) {
        ...
        int orientation = a.getInt(R.styleable.MultiDirectionSlidingDrawer_draw_direction, ORIENTATION_BTT);
...
//        });
    ...
    private void performFling(int position, float velocity, boolean always) {
        ...
        if (mExpanded) {
            ...
            c2 = mInvert ? (bottom - (position + handleHeight)) + mBottomOffset > handleHeight : position > mTopOffset + (mVertical ? mHandleHeight
                    : mHandleWidth);
    ...
    private void prepareContent() {
        ...
        if (content.isLayoutRequested()) {
            ...
            if (mVertical) {
                ...
                content.measure(MeasureSpec.makeMeasureSpec(width, MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(getBottom() - getTop(),
                        MeasureSpec.EXACTLY));
