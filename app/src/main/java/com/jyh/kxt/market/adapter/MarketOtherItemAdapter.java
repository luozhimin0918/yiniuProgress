...
public class MarketOtherItemAdapter extends BaseListAdapter<MarketOtherBean> {

    private Context mContext;
    private LayoutInflater mInflater;

    public MarketOtherItemAdapter(Context mContext, List<MarketOtherBean> dataList) {
        super(dataList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MarketOtherBean marketItemBean = dataList.get(position);
