...
public class HuaWeiPushReceiver extends PushReceiver {
    ...
    public void onEvent(Context context, Event event, Bundle extras) {
        ...
        String pushContent = JSONObject.parseArray(message).getJSONObject(0).getString("pushContent");
        PushJsonHandle.getInstance().notificationHuaWeiDisplay(context, pushContent);
