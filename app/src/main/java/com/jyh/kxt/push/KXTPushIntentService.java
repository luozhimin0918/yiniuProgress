...
//import com.jyh.kxt.push.json.FlashItemBean;
...
//                        FlashItemBean itemKuaiXun = JSON.parseObject(kxunInfo.getContent().toString(), FlashItemBean.class);
//                        if (itemKuaiXun != null) {
...
//                    if (push && cjInfo != null) {
//                        NotificationKXT notification = new NotificationKXT();
//                        notification.sendPushUmengNoifiyCJRL(
//                                KXTPushIntentService.this,
//                                cjInfo, push_sound);
//                    }
